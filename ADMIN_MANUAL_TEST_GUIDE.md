...
**App URL**: https://pending-invoice-flow.preview.emergentagent.com  
**Admin URL**: https://pending-invoice-flow.preview.emergentagent.com/admin
...
- Check API response: `curl https://pending-invoice-flow.preview.emergentagent.com/api/gallery`
