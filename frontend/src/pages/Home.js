        ...
        <div className="container-custom max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4 md:space-y-6 text-left">
              <p className="text-xl md:text-4xl opacity-0 transition-all duration-700 delay-100" data-scroll-reveal>
                <span className="text-[#d4af37]">Color</span> is the goal.
              </p>
              <p className="text-xl md:text-4xl opacity-0 transition-all duration-700 delay-200" data-scroll-reveal>
                <span className="text-[#d4af37]">Conscious</span> of the weight.
              </p>
              <p className="text-xl md:text-4xl opacity-0 transition-all duration-700 delay-300" data-scroll-reveal>
                <span className="text-[#d4af37]">Careful</span> with my approach.
              </p>
              <p className="text-xl md:text-4xl opacity-0 transition-all duration-700 delay-400" data-scroll-reveal>
        ...
        <div className="container-custom">
          ...
          <div className="hidden md:grid grid-cols-3 gap-8">
            {[
              ...
              { icon: Gem, title: 'Sell Gemstones', desc: 'An online shop with custom and flexible purchasing features, including pay now, pay later, inquiries and negotiations directly through the site.' },
              ...
              <div 
                key={service.title}
                className="gem-card p-10 hover-lift opacity-0 transition-all duration-700"
                style={{ animationDelay: `${i * 100}ms` }}
                data-scroll-reveal
              >
                <service.icon className="w-10 h-10 mb-6 text-[#d4af37] opacity-0 transition-all duration-700" data-scroll-reveal strokeWidth={1.5} />
                <h3 className="title-sm text-2xl mb-3">{service.title}</h3>
